...
// Componente responsável pela exibição e interação na página de login do sistema
...
export class LoginComponent implements OnInit {
  ...
  constructor(
    private formBuilder: FormBuilder, // Serviço Angular para construção de formulários reativos
    private router: Router, // Serviço Angular para navegação entre rotas
    private userService: UserService, // Serviço responsável por interações relacionadas aos usuários
    private webTokenService: WebTokenService, // Serviço para manipulação do token de autenticação
    private activatedRoute: ActivatedRoute // Serviço Angular para acesso aos parâmetros da rota ativa
  ) {}
  ...
  // Inicializa os estilos e eventos do componente
  ...
  // Ajusta a altura de exibição com base na largura da janela
